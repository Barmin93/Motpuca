...
anyCell::anyCell() : tissue(0), pos(0, 0, 0), pos_h1(-1000000000, 0, 0), pos_h2(-1000000000, 0, 0), r(0), state(sat::csAlive), age(0), state_age(0), no_cells_in_box(0),
    one_by_mass(0), velocity(0, 0, 0), force(0, 0, 0), pressure(0), pressure_prev(0), pressure_avg(0), pressure_sum(0), time_to_necrosis(0), density(0), viscosityF(0), fluid_viscosity(0), mark(false)
{
