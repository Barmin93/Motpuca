...
public:
    ...
    anyVector acc;             ///< acceleration
    anyVector force;           ///< force
    anyVector pressureF;             ///< pressure - float value of pressure in cell, may not be used in visualization or any calculations inside CellCellForces
